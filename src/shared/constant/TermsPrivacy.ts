export const TERMS_PRIVACY = {
  terms: {
    ...
    content: `
      ...
      본 이용약관은 “Bizket”(이하 "비즈켓")의 서비스의 이용조건과 운영에 관한 제반 사항 규정을 목적으로 합니다.
      ...
      ③ 운영자는 회원이 게시하거나 등록하는 사이트 내의 내용물, 게시 내용에 대해 제12조 각호...
    `,
  },
  privacy: {
    title: '개인정보 처리방침',
    content: `
      ...
      1. 홈페이지 회원 가입 및 관리
      필수항목 : <인스타그램 아이디, 인스타그램 비밀번호>  
      선택항목 : <성명, 전화번호, 인스타그램 계정명, 스레드 계정명, 상호명, 사업 시작일, 업종, 사업장 주소, 고객 연령층>
  
      2. 재화 또는 서비스 제공
      필수항목 : <인스타그램 아이디, 인스타그램 비밀번호>  
      선택항목 : <컨텐츠 생성 이력, 인스타그램 인사이트 데이터>
      ...
      성명 : 정현희  
      직책 : PM  
      연락처 : <01099802268>, <nyeonui02@gmail.com>  
      ※ 개인정보 보호 담당부서로 연결됩니다.
      ...
      4. 경찰청 : (국번없이) 182 ([ecrm.police.go.kr/minwon/main](http://ecrm.police.go.kr/minwon/main))
  
      제11조(개인정보 처리방침 시행 및 변경)
      이 개인정보 처리방침은 2025. 05. 18. 부터 적용됩니다.
    `,
  },
};
